      ...
      components: {
        ...
        //Usuario
          ...
          Disciplina: {
            ...
            properties: {
              ...
              professores: {
                ...
                items: {
                  type: 'string',
                  description: 'Lista de IDs dos professores associados à disciplina',
                },
              },
              turmas: {
                type: 'array',
                items: {
                  type: 'string',
                  description: 'Lista de IDs das turmas associadas à disciplina',
                },
              },
            },
          ...
          Notificacao: {
            ...
            required: ['titulo', 'descricao', 'data', 'usuarioId'],
          },
          ...
          Comunicado: {
            ...
            properties: {
              ...
              dataEnvio: {
                type: 'string',
                format: 'date-time',
                description: 'Data de envio do comunicado',
              },
            },
            required: ['titulo', 'descricao', 'dataEnvio'],
          },
